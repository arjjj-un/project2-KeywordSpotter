...
def write_c_header(blob: bytes, path: pathlib.Path, var_name: str = "model"):
...
def save_training_curves(history, out_path: pathlib.Path):
    ...
    axes[0].set_title("Alexa+Yes Loss")
    ...
    axes[1].set_title("Alexa+Yes Accuracy")
...
def main():
    ...
    keras_path = pathlib.Path("alexa_yes_tflm.keras")
