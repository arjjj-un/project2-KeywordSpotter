...
axes[0].set_title("Loss - Alexa/Yes  CNN+GRU)")
axes[0].legend()
...
axes[1].set_title("Accuracy - Alexa/Yes (CNN+GRU)")
axes[1].legend()
...
plt.ylabel("True")
plt.title("Confusion Matrix - Alexa/Yes (CNN+GRU)")
plt.tight_layout()
